    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="警戒值" prop="shangpinYuzhi">
                       <el-input v-model="ruleForm.shangpinYuzhi"
                                 placeholder="警戒值" clearable  :readonly="ro.shangpinYuzhi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="警戒值" prop="shangpinYuzhi">
                           <el-input v-model="ruleForm.shangpinYuzhi"
